...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="mx-10 my-5">
            <h3 class="font-medium leading-tight text-3xl mt-0 mb-2 text-slate-700">Make a Booking</h3>
        </div>

        <<div class="flex-start grid grid-cols-5 w-90 p-1 justify-items-center mx-20">
    ...
    <div class="mx-10 my-3">
        <h3 class="font-medium leading-tight text-3xl mt-0 mb-2 text-slate-700">Arena Nearby</h3>
    </div>
